...
add_action( 'widgets_init', 'evenz_widgets_cards' );
function evenz_widgets_cards() {
	register_widget( 'evenz_widgets_cards' );
}
class evenz_widgets_cards extends WP_Widget {
	function __construct() {
		$widget_ops = array( 'classname' => 'cardswidget', 'description' => esc_attr__('List of posts using featured card', "evenz-widgets") );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'evenz_widgets_cards' );
		parent::__construct( 'evenz_widgets_cards', esc_attr__('Archives Cards Widget', "evenz-widgets"), $widget_ops, $control_ops );
	}

...
2017 04 25 *  added support for page template to fully hide/show a fields container adding 6th parameter to custom_add_meta_box. The parameter is the page template name (page-template.php)
...
class Custom_Add_Meta_Box {
	...
	function add_box() {
		/*
		20170425 *  added support for page template to fully hide/show a fields container adding 6th parameter to custom_add_meta_box. The parameter is the page template name (page-template.php)
		*/

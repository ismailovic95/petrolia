...
add_action( 'widgets_init', 'firwl_widget_list' );
function firwl_widget_list() {
	register_widget( 'firwl_widget_list' );
}
class firwl_widget_list extends WP_Widget {
	function __construct() {
		$widget_ops = array( 'classname' => 'listwidget', 'description' => esc_attr__('List of posts', "firwl-widgets") );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'firwl_widget_list' );
		parent::__construct( 'firwl_widget_list', esc_attr__('Firwl Post List Widget', "firwl-widgets"), $widget_ops, $control_ops );
	}

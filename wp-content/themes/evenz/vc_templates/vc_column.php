 ...
 */
$evenz_section = $evenz_stickycolumn = $el_class = $el_id = $width = $parallax_speed_bg = $parallax_speed_video = $parallax = $parallax_image = $video_bg = $video_bg_url = $video_bg_parallax = $css = $offset = $css_animation = '';
$output = '';
...
/**
 * Evenz columns width fix tablet
 */
$evenz_cols_array = explode( ' ', $width );
foreach( $evenz_cols_array as $ttg_cols_class ){
...
// customization
if($evenz_stickycolumn){
	$css_classes[] = 'evenz-stickycol';
}
...
$wpb_wrapper_class = '';
if($evenz_section){
	$wpb_wrapper_class  = 'evenz-vc_section';
}

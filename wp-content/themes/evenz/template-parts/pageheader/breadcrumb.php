...
?>
<div class="evenz-pageheader__breadcrumb">
	<ul id="evenz-breadcrumb" class="evenz-breadcrumb evenz-small">
		<?php 
		if (!is_home() && !is_front_page()) { 
			?>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home', 'evenz'); ?></a></li>
			<?php  
			if (is_category() ) {
				?>
			...
			elseif (is_single()) {
				...
				if( get_post_format(  ) == 'audio'){
					?>
					<li><i class="material-icons">keyboard_arrow_right</i><a href="<?php echo get_post_format_link( 'audio' ); ?>"><?php esc_html_e("Podcasts", "evenz") ?></a></li>
					<?php
				}
				if( function_exists( 'qt_series_custom_series_name' )){
			...
			elseif (is_day()) { ?>
				<li><i class="material-icons">keyboard_arrow_right</i><?php esc_html_e('Archive for',"evenz"); the_time('F jS, Y'); ?></li>
				<?php
			}
			elseif (is_month()) { ?>
				<li><i class="material-icons">keyboard_arrow_right</i><?php esc_html_e('Archive for',"evenz"); the_time('F, Y'); ?></li>
				<?php
			}
			elseif (is_year()) { ?>
				<li><i class="material-icons">keyboard_arrow_right</i><?php esc_html_e('Archive for',"evenz"); the_time('Y'); ?></li>
				<?php
			}
			elseif (is_author()) { ?>
				<li><i class="material-icons">keyboard_arrow_right</i><?php esc_html_e('Author archive',"evenz"); the_time('Y'); ?></li>
				<?php
			}
			elseif (isset($_GET['paged']) && !empty($_GET['paged'])) {
				?>
				<li><i class="material-icons">keyboard_arrow_right</i><span><?php esc_html_e('Blog archive',"evenz"); ?></span></li>
				<?php 
			}
			elseif (is_search()) {
				?>
				...
				printf( 
					esc_html__( 'Search Results for: %s', "evenz" ), 

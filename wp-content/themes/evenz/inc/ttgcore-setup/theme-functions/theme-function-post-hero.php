...
if(!function_exists( 'evenz_template_post_hero' )){
	function evenz_template_post_hero( $atts = array() ){
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-post-hero","evenz_template_post_hero");
}
 ...
 */
add_action( 'vc_before_init', 'evenz_template_post_hero_vc' );
if(!function_exists('evenz_template_post_hero_vc')){
	function evenz_template_post_hero_vc() {
  		vc_map( 
  			array(
				"name" => esc_html__( "Post hero", "evenz" ),
				"base" => "qt-post-hero",
				"icon" => get_theme_file_uri( '/inc/ttgcore-setup/theme-functions/img/post-hero.png' ),
				"description" => esc_html__( "Post hero", "evenz" ),

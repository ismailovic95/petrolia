...
if(!function_exists( 'evenz_template_post_list' )){
	function evenz_template_post_list( $atts = array() ){
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-post-list","evenz_template_post_list");
}
 ...
 */
add_action( 'vc_before_init', 'evenz_template_post_list_vc' );
if(!function_exists('evenz_template_post_list_vc')){
	function evenz_template_post_list_vc() {
  		vc_map( 
  			array(
				"name" => esc_html__( "Post list - large", "evenz" ),
				"base" => "qt-post-list",
				"icon" => get_theme_file_uri( '/inc/ttgcore-setup/theme-functions/img/post-list.png' ),

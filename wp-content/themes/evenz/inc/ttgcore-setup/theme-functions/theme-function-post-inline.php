...
if(!function_exists( 'evenz_template_post_inline' )){
	function evenz_template_post_inline( $atts = array() ){
		...
		if ( $wp_query->have_posts() ) : 
			...
			?>
			<div id="<?php echo esc_attr( $list_id ); ?>" class="evenz-post-inline-horizontal">
				<?php  
				/**
				 * Loop
				 */
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-post-inline","evenz_template_post_inline");
}
 ...
 */
add_action( 'vc_before_init', 'evenz_template_post_inline_vc' );
if(!function_exists('evenz_template_post_inline_vc')){
	function evenz_template_post_inline_vc() {
  		vc_map( 
  			array(
				"name" => esc_html__( "Post list - inline", "evenz" ),
				"base" => "qt-post-inline",
				"icon" => get_theme_file_uri( '/inc/ttgcore-setup/theme-functions/img/post-inline.png' ),
				"description" => esc_html__( "List of posts with classic design", "evenz" ),

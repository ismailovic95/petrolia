...
if(!function_exists( 'evenz_template_post_mosaic' )){
	function evenz_template_post_mosaic( $atts = array() ){
		...
		if ( $wp_query->have_posts() ) : 
			...
			?>
			<div id="<?php echo esc_attr( $list_id ); ?>" class="evenz-mosaic">
				<div class="evenz-mosaic__c">
					<?php  
					/**
					 * Loop
					 */
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-mosaic","evenz_template_post_mosaic");
}
 ...
 */
add_action( 'vc_before_init', 'evenz_template_post_mosaic_vc' );
if(!function_exists('evenz_template_post_mosaic_vc')){
	function evenz_template_post_mosaic_vc() {
  		vc_map( 
  			array(
				"name" => esc_html__( "Post mosaic", "evenz" ),
				"base" => "qt-mosaic",
				"icon" => get_theme_file_uri( '/inc/ttgcore-setup/theme-functions/img/mosaic.png' ),
				"description" => esc_html__( "Full width mosaic of posts", "evenz" ),

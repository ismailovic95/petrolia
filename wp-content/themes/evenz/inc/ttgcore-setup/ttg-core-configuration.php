...
if(function_exists('ttg_core_active') ){
	...
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/page/page-internal-menu.php' );

	// Schedule settings and display
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/schedule/schedule-type.php' );
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/schedule/schedule-display.php' );

	// Event settings and display
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/event/event-type.php' );
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/event/event-program-display.php' );

	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/member/member-type.php' );
	require_once get_theme_file_path( '/inc/ttgcore-setup/custom-types/testimonial/testimonial-type.php' );

	/**
	 * Author box settings (if the plugin Themes2Go Author Box is enabled)
	 * @var $qt_user_social [array] list of social icons that overrides the default in TTG Core Plugin
	 */

    <?php if (has_post_thumbnail()) : ?>
       <div class="post-media post-video">
          ...
          <?php if (class_exists('CSF') && exhibz_meta_option(get_the_ID(), 'featured_video') != '') : ?>
             <div class="video-link-btn">
                <a href="<?php echo exhibz_meta_option(get_the_ID(), 'featured_video'); ?>" class="play-btn video-btn"><i class="icon icon-play"></i></a>
             </div>
          <?php endif; ?>
       </div>
    <?php endif; ?>

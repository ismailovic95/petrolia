...
?>
<!-- header nav start-->
<header class="header-standard <?php echo (exhibz_option('header_nav_sticky_section', false) == true) ? "navbar-fixed" : ''; ?> ">
    <div class="container">
        <div class="row">
            ...
            <div class="<?php echo esc_html($header_btn_show) == true ? 'col-lg-7' : 'col-lg-9'; ?>">

...
if(class_exists('CSF') && theme_is_valid_license()) {
    ...
    // header cart
    $show_shopping_cart = exhibz_option('header_nav_shopping_cart_section', false);
} else {
    $header_btn_show = "no";
	$header_btn_url = "#";
...
?>
<!-- header nav start-->
<header class="header-standard header-woo<?php echo (exhibz_option('header_nav_sticky_section', false) == true) ? "navbar-fixed" : ''; ?> ">
    <div class="container">
        <div class="row">
            ...
            <div class="<?php echo esc_html($header_btn_show == true || $show_shopping_cart == true) ? 'col-lg-7' : 'col-lg-9'; ?>">
				<?php get_template_part('template-parts/navigations/nav', 'primary'); ?>
            </div>

			<?php if($header_btn_show == true || $show_shopping_cart == true) { ?>
                <div class="col-lg-3 d-none d-lg-block text-lg-right">
					...
					<?php if($show_shopping_cart == true && class_exists('WooCommerce')): ?>
                        <a class="cart-btn" href="<?php echo wc_get_cart_url(); ?>"
                           title="<?php _e('View your shopping cart', 'exhibz'); ?>">

...
<!-- header nav start-->
<header id="header"
        class="header header-transparent h-transparent2 <?php echo (exhibz_option('header_nav_sticky_section', false) == true) ? "navbar-fixed" : ''; ?> ">
    <div class="container">
        <div class="row">
            ...
            <div class="align-self-center <?php echo ($header_btn_show == true) ? 'col-lg-10' : 'col-lg-10'; ?>">

...
function exhibz_register_required_plugins() {
	$plugins	 = array(
		...
		array(
			'name'     => esc_html__( 'Codestar Framework', 'digiqole' ),
		...
		array(
			'name'     => esc_html__( 'One Click Demo Import', 'eventplace' ),
		...
		array(
			'name'		 => esc_html__( 'Elementskit Lite', 'exhibz' ),
		...
		array(
			'name'		 => esc_html__( 'Eventin', 'exhibz' ),
		...
		array(
			'name'		 => esc_html__( 'Timetics', 'exhibz' ),
			'slug'		 => 'timetics',
		),
		array(
			'name'		 => esc_html__( 'MetForm', 'exhibz' ),
			'slug'		 => 'metform',
		),
	);

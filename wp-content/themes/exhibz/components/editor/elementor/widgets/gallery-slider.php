	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'exhibz_gallery_item', [
                ...
                'default' => esc_html__('Slide 1', 'exhibz'),
                'label_block' => true,
			]
        );
		$repeater->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'exhibz_gallery_item' => esc_html__(' Carousel #1', 'exhibz'),
					],
					[
						'exhibz_gallery_item' => esc_html__(' Carousel #2', 'exhibz'),
					],
					[
						'exhibz_gallery_item' => esc_html__(' Carousel #3', 'exhibz'),
					],
				],
				'title_field' => '{{{ exhibz_gallery_item }}}',
			]
		);
						...
						<?php if(isset($value["exhibz_slider_bg_image"]["url"]) && $value["exhibz_slider_bg_image"]["url"] != ''): ?>
                            <div class="swiper-slide">
                                <div class="galler-img-item">
                                    <a href="<?php echo esc_url($value["exhibz_slider_bg_image"]["url"]); ?>"
                                       class="gallery-popup">
                                        <img src="<?php echo esc_url($value["exhibz_slider_bg_image"]["url"]); ?>"
                                             alt="<?php echo esc_attr('gallery', 'exhibz'); ?>">
                                    </a>
                                </div>
                            </div>
						<?php endif; ?>

            ...
            <div class="<?php echo esc_attr($swiper_class); ?>">
                <div class="swiper-wrapper">
					<?php foreach($posts1 as $post) :
						...
						$speaker_image       = exhibz_meta_option($speaker_id, 'exhibs_photo', '');
						$speaker_logo        = exhibz_meta_option($speaker_id, 'exhibs_logo', '');
						$speaker_designation = exhibz_meta_option($speaker_id, 'exhibs_designation', '');
						$speaker_summery     = exhibz_meta_option($speaker_id, 'exhibs_summery', '');
						$speaker_social      = exhibz_meta_option($speaker_id, 'social', []);
						?>
                            ...
                            <div class="ts-speaker">
                                ...
                                <div class="speaker-img">
									<?php if(!empty($speaker_image)) : ?>
										<?php echo wp_get_attachment_image($speaker_image['id'], 'large', false); ?>
									<?php endif; ?>
                                ...
                                <div class="ts-speaker-info">
                                    ...
                                    <p>
										<?php echo esc_html($speaker_designation); ?>
                                    </p>
                                </div>
                                <!--- speaker info end -->
                                <!-- popup start-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="ts-speaker-popup-content">
                                                <h3 class="ts-title"><?php echo esc_html(get_the_title($speaker_id)); ?> </h3>
                                                <p class="speakder-designation"> <?php echo esc_html($speaker_designation); ?></p>
												<?php if(!empty($speaker_logo)) : ?>
													<?php echo wp_get_attachment_image($speaker_logo['id'], 'large', false, ['class' => 'company-logo']); ?>
												<?php endif; ?>
                                                <p>
													<?php echo exhibz_kses($speaker_summery); ?>
                                                </p>
												<?php if(!empty($speaker_social)) : ?>
                                                    <div class="ts-speakers-social">
														<?php foreach($speaker_social as $social_bookmark) : ?>
                                                            <a href="<?php echo esc_url($social_bookmark["option_site_link"]); ?>"
                                                               rel="noreferrer"
                                                               aria-label="<?php echo esc_html($social_bookmark["option_site_name"]); ?>"
                                                            >
                                                                <i class="<?php echo esc_attr($social_bookmark["option_site_icon"]); ?>"></i>
                                                            </a>
														<?php endforeach; ?>
                                                    </div>
												<?php endif ?>

			...
			<?php foreach($exhibz_slider as $key => $value):
                ...
                <div class="swiper-slide">
                    <div class="banner-item overlay"
                         style="background-image:url(<?php echo is_array($value["exhibz_slider_bg_image"]) ? $value["exhibz_slider_bg_image"]["url"] : ''; ?>)">
                        <div class="container">
                                ...
                                <div class="<?php echo esc_attr($col); ?> <?php echo esc_attr($value["justify_content_text"] == 'yes' ? '' : $value['content_align_text']); ?>">
                                    <div class="banner-content-wrap">
										<?php if($value["exhibz_show_title_shap"] == "yes"): ?>
                                            <img class="title-shap-img"
                                                 src="<?php echo esc_url(EXHIBZ_IMG . '/shap/title-white.png'); ?> "
                                                 alt="<?php esc_attr_e('shape', 'exhibz'); ?> ">
										<?php endif; ?>
                                        ...
                                        <div class="ts-banner-btn">
											<?php if($value["exhibz_button_one_text"] != ''): ?>
                                                <a href="<?php echo esc_url($value["exhibz_button_one"]["url"]); ?>"
                                                   class="btn"
                                                   target="<?php echo esc_attr($value["exhibz_button_one"]["is_external"] == "on" ? "_blank" : '_self'); ?>"
                                                   rel="<?php echo esc_attr($value["exhibz_button_one"]["nofollow"] == "on" ? "" : 'nofollow'); ?>"><?php echo esc_html($value["exhibz_button_one_text"]); ?></a>
											<?php endif; ?>
											<?php if($value["exhibz_button_two_text"] != ''): ?>
                                                <a href="<?php echo esc_url($value["exhibz_button_two"]["url"]); ?>"
                                                   class="btn fill"
                                                   target="<?php echo esc_attr($value["exhibz_button_two"]["is_external"] == "on" ? "_blank" : '_self'); ?>"
                                                   rel="<?php echo esc_attr($value["exhibz_button_two"]["nofollow"] == "on" ? "" : 'nofollow'); ?>"><?php echo esc_html($value["exhibz_button_two_text"]); ?></a>
											<?php endif; ?>
                                        </div>

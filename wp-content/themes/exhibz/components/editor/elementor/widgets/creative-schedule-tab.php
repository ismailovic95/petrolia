...
class Exhibz_Creative_Schedule_Tab extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'creative-schedule-tab-1',
                'options' => [
                    'creative-schedule-tab-1' => esc_html__( 'Tab Style 1', 'exhibz' ),
                    'creative-schedule-tab-2' => esc_html__( 'Tab Style 2', 'exhibz' ),
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
         ...
         $this->add_control(
			'slider_center',
			[
				'label'     => esc_html__( 'Slider Center?', 'exhibz' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .schedule-tab-wrapper .etn-nav li a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'etn_nav_hover_background',
            [
                'label'     => esc_html__('Hover Background Color', 'exhibz'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .schedule-tab-wrapper .etn-nav li a.etn-active' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
    ...
    protected function render()
    {
        ...
        $slider_center  = $settings['slider_center'];
